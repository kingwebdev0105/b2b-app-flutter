...
class CustomerFindBillerInfoForm extends StatelessWidget {
        ...
        child: ListView(
          ...
          children: [
            Padding(
              ...
              child: RichText(
                text: TextSpan(
                  ...
                  children: <TextSpan>[
                    TextSpan(text: 'Biller Information', style: Theme.of(context).textTheme.headline6),
                  ],
                ),
            ...
            DropdownButtonFormField<String>(
              decoration: _helper.defaultFormFieldStyle(hintText: 'Service'),
              items: <String>['IT', 'Finance', 'Real Estate'].map<DropdownMenuItem<String>>(
                (String value) {
                  return DropdownMenuItem<String>(
                    value: value,
                    child: Text(value),
